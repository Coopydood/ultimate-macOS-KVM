...
def autopilot():
   ...
   def stage12():
      ...
      clear()
      print("   "+color.BOLD+"━━━━━━━12/14━━━━━"+color.GRAY+"━━"+color.END)
      print("\n   "+color.BOLD+"macOS Recovery image file"+color.END)
      #print("   Step 12")
      print("   Choose a bootable image file the virtual machine should boot to. \n   You need a macOS Recovery image (BaseSystem). You can either\n   select an existing one or AutoPilot can download one for you.\n   It must be in the *.img or *.dmg file format."+color.END)
   ...
   def stage9():
      ...
      if USR_HDD_ISPHYSICAL != True:
         ...
         #print("   Step 9")
         print("   Select what type of storage your physical disk is. \n   This affects SSD-based features, such as TRIM."+color.END)
   ...
   def stage8():
      ...
      clear()
      print("   "+color.BOLD+"━━━━━━━8/1"+color.GRAY+"4━━━━━━━"+color.END)
      if customValue != 3:
   ...
   def stage7():
      ...
      clear()
      print("   "+color.BOLD+"━━━━━━━7"+color.GRAY+"/14━━━━━━━"+color.END)
      print("\n   "+color.BOLD+"Allocate virtual memory"+color.END)
      #print("   Step 7")
      print("   Choose how much memory the guest can use. \n   As a general rule and for max performance, use no\n   more than half of your total host memory."+color.END)
      print("\n   "+color.BOLD+color.CYAN+"DEFAULT:",color.END+color.BOLD+defaultValue+color.END)
      if customValue == 1:
         cpydLog("info",str("Custom value requested, setting up"))
      #   print(color.BOLD+color.PURPLE+"\n   FORMAT:"+color.YELLOW+""+color.END+color.BOLD,"<>"+color.YELLOW+""+color.END+"\n   Enter a custom value.\n   \n   ")
   ...
   def stage6():
      ...
      clear()
      print("   "+color.BOLD+"━━━━━━"+color.GRAY+"━6/14━━━━━━━"+color.END)
      print("\n   "+color.BOLD+"Virtual CPU feature arguments"+color.END)
      #print("   Step 6")
      print("   Choose the virtual CPU's feature arguments. \n   Do not change this unless you know what you're doing.\n   The default is more than enough for most people."+color.END)
      print("\n   "+color.BOLD+color.CYAN+"DEFAULT:",color.END+color.BOLD+defaultValue+color.END)
      if customValue == 1:
         cpydLog("info",str("Custom value requested, setting up"))
      #   print(color.BOLD+color.PURPLE+"\n   FORMAT:"+color.YELLOW+""+color.END+color.BOLD,"<>"+color.YELLOW+""+color.END+"\n   Enter a custom value.\n   \n   ")
   ...
   def stage5():
      ...
      clear()
      print("   "+color.BOLD+"━━━━━"+color.GRAY+"━━5/14━━━━━━━"+color.END)
      print("\n   "+color.BOLD+"Virtual CPU model"+color.END)
      #print("   Step 5")
      print("   Choose the model of the virtual CPU. \n   Unless your host CPU is supported in macOS, leave this alone.\n   Use \"host\" to expose the host CPU model to the guest."+color.END)
      print("\n   "+color.BOLD+color.CYAN+"DEFAULT:",color.END+color.BOLD+defaultValue+color.END)
      if customValue == 1:
         cpydLog("info",str("Custom value requested, setting up"))
         print(color.BOLD+color.PURPLE+"\n   FORMAT:"+color.YELLOW+""+color.END+color.BOLD,"<model name>"+color.YELLOW+""+color.END+"\n   Enter a custom value.\n   \n   ")
   ...
   def stage4():
      ...
      clear()
      print("   "+color.BOLD+"━━━━"+color.GRAY+"━━━4/14━━━━━━━"+color.END)
      print("\n   "+color.BOLD+"Virtual CPU threads"+color.END)
      #print("   Step 4")
      print("   Choose the desired number of virtual CPU threads. \n   Like cores, more threads can dramatically improve\n   guest performance if your host can handle it.\n\n   "+color.END+color.BOLD+color.YELLOW+"WARNING:",color.END+color.BOLD+"This value is the number of\n            threads per each individual core."+color.END)
      print("\n   "+color.BOLD+color.CYAN+"DEFAULT:"+color.END+color.BOLD,defaultValue,color.END)
      if customValue == 1:
         cpydLog("info",str("Custom value requested, setting up"))
         print(color.BOLD+color.PURPLE+"\n   FORMAT:"+color.YELLOW+""+color.END+color.BOLD,"<number>"+color.YELLOW+""+color.END+"\n   Enter a custom value.\n   \n   ")
   ...
   def stage3():
      ...
      print("   "+color.BOLD+"━━━"+color.GRAY+"━━━━3/14━━━━━━━"+color.END)
      print("\n   "+color.BOLD+"Virtual CPU cores"+color.END)
      #print("   Step 3")
      print("   Choose the desired number of virtual CPU cores. \n   More cores can dramatically improve guest performance if\n   your host can handle it."+color.END)
      print("\n   "+color.BOLD+color.CYAN+"DEFAULT:"+color.END+color.BOLD,defaultValue,color.END)
      if customValue == 1:
         cpydLog("info",str("Custom value requested, setting up"))
         print(color.BOLD+color.PURPLE+"\n   FORMAT:"+color.YELLOW+""+color.END+color.BOLD,"<number>"+color.YELLOW+""+color.END+"\n   Enter a custom value.\n   \n   ")
   ...
   def stage2():
      ...
      clear()
      print("   "+color.BOLD+"━━"+color.GRAY+"━━━━━2/14━━━━━━━"+color.END)
      print("\n   "+color.BOLD+"Target OS"+color.END)
      #print("   Step 2")
      print("   This configures networking and image download version. \n   The most suitable network adapter will be automatically\n   selected for you based on this later."+color.END)
   ...
   def handoff():
      ...
      def throwError():
         ...
         print("\n   "+color.BOLD+color.RED+"UNABLE TO CONTINUE"+color.END)
